...
Public Class Assets
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.Fields = New String() {SubId, SubName, "AccNo", "Notes", "DepreciationAccNo", "CompoundDepreciationAccNo", "ApplyCurrencyCycle", "CurrencyId", "Exchange", "MainBal0", "Bal0", "SalesPrice", "PreviousCompoundValue", "DepreciationRate", "DayDate", "IsStopped", "PurchasePrice"}
        bm.control = New Control() {txtID, txtName, AccNo, Notes, DepreciationAccNo, CompoundDepreciationAccNo, ApplyCurrencyCycle, CurrencyId, Exchange, MainBal0, Bal0, SalesPrice, PreviousCompoundValue, DepreciationRate, DayDate, IsStopped, PurchasePrice}
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If txtID.Text.Trim = "" OrElse txtName.Text.Trim = "" Then
            txtName.Focus()
            Return
        End If
    ...
    Private Sub txtID_KeyPress2(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles Bal0.KeyDown, MainBal0.KeyDown, Exchange.KeyDown, SalesPrice.KeyDown, btnPrevios.KeyDown, DepreciationRate.KeyDown, PurchasePrice.KeyDown
