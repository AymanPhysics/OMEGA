...
Public Class BankCash_G
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        LoadResource()
        bm.Fields = New String() {MainId, SubId, SubId2, "DayDate", "DayDate2", "Canceled", "CurrencyId", "IsPosted"}
        bm.control = {BankId, txtFlag, txtID, DayDate, DayDate2, Canceled, CurrencyId, IsPosted}
        ...
        If Not Md.MyProjectType = ProjectType.AboHamza Then
            ...
            Notes0.Visibility = Visibility.Hidden
            lblNotes0.Visibility = Visibility.Hidden
        End If

        If Not Md.MyProjectType = ProjectType.AboHamza OrElse Flag <> 1 Then
            lblDayDate2.Visibility = Visibility.Hidden
    ...
    Private Sub LoadWFH()
        ...
        If (Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X4 OrElse Md.MyProjectType = ProjectType.X1) AndAlso (Flag = 2 OrElse Flag = 4) Then
    ...
    Sub FillControls()
        ...
        If G.Rows.Count > 0 Then G.CurrentCell = G.Rows(0).Cells(GC.Notes)
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Not bm.Save(New String() {MainId, SubId, SubId2}, New String() {BankId.Text, txtFlag.Text.Trim, txtID.Text}) Then
    ...
    Private Sub GridCalcRow(ByVal sender As Object, ByVal e As Forms.DataGridViewCellEventArgs)
        Try
            If Md.MyProjectType = ProjectType.AboHamza AndAlso Val(G.Rows(G.CurrentCell.RowIndex).Cells(GC.LinkFile).Value) = 0 Then
    ...
    Private Sub txtID_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtID.LostFocus
        ...
        If dt.Rows.Count = 0 OrElse Val(txtID.Text) = 0 Then
            ClearControls()
            lv = False
            Return
        End If
        ...
        If Not lop AndAlso Val(G.Rows(i).Cells(GC.SubAccNo).Value) > 0 AndAlso Md.MyProjectType <> ProjectType.APS Then
            Select Case G.Rows(i).Cells(GC.LinkFile).Value
                Case 1
                    ...
                    Notes0.Text = bm.ExecuteScalar("select Notes from Customers where Id='" & Val(G.CurrentRow.Cells(GC.SubAccNo).Value) & "'")


                    dt = bm.ExecuteAdapter("exec GetSalesRPT4  {ts '2000-01-01 00:00:00'}, {ts '" & bm.MyGetDate() & " 00:00:00'}, {ts '" & bm.MyGetDate() & " 00:00:00'}, 0, 0, 0, 0, 0, 0, 31, 0, 0, " & Val(G.CurrentRow.Cells(GC.SubAccNo).Value) & ", 0, 0, 0, 0, 0, 0, 0, 0")
    ...
    Sub SaveCustomerData()
        If G.CurrentRow Is Nothing Then Return
        bm.ExecuteNonQuery("update Customers set MonthlyPayment='" & Val(MonthlyPayment.Text) & "',MonthlyPaymentDay='" & Val(MonthlyPaymentDay.Text) & "',Notes='" & Notes0.Text.Trim.Replace("'", "''") & "' where Id='" & Val(G.CurrentRow.Cells(GC.SubAccNo).Value) & "'")
    End Sub
