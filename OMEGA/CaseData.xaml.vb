...
Public Class CaseData
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If txtID.Text.Trim = "" OrElse txtName.Text.Trim = "" AndAlso txtName2.Text.Trim = "" AndAlso txtName3.Text.Trim = "" AndAlso txtName4.Text.Trim = "" Then
            'Return
        End If
    ...
    Sub ClearControls()
        Try
            ...
            txtName3.Clear()
            txtName4.Clear()
            txtID.Text = bm.ExecuteScalar("select isnull(max(" & SubId & "),0)+1 from " & TableName & " where " & MainId & "='" & CboMain.SelectedValue.ToString & "' and " & MainId2 & "='" & txtMyKey.Text & "' and " & MainId3 & "='" & txtMyFlag.Text & "'")
