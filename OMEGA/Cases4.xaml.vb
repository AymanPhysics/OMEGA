...
Public Class Cases4
    ...
    Structure GC
        Shared IsCanceled As String = "IsCanceled"
        ...
        Shared OperationId2 As String = "OperationId2"
        Shared RoomId As String = "RoomId"
    ...
    Private Sub LoadWFH()
        ...
        Dim GCIsCanceled As New Forms.DataGridViewCheckBoxColumn
        GCIsCanceled.HeaderText = "ملغي"
        GCIsCanceled.Name = GC.IsCanceled
        G.Columns.Add(GCIsCanceled)
        ...
        GCOperationId.HeaderText = "العملية 1"
        ...
        Dim GCOperationId2 As New Forms.DataGridViewComboBoxColumn
        GCOperationId2.HeaderText = "العملية 2"
        GCOperationId2.Name = GC.OperationId2
        bm.FillCombo("select 0 Id,'-' Name union all select Id,Name From OperationTypes where IsStopped=0", GCOperationId2)
        G.Columns.Add(GCOperationId2)

        Dim GCRoomId As New Forms.DataGridViewComboBoxColumn
        GCRoomId.HeaderText = "الغرفة"
        GCRoomId.Name = GC.RoomId
        bm.FillCombo("select 0 Id,'-' Name union all select Id,Name From Rooms", GCRoomId)
        G.Columns.Add(GCRoomId)
    ...
    Sub FillControls()
        ...
        For i As Integer = 0 To dt.Rows.Count - 1
            ...
            G.Rows(i).Cells(GC.IsCanceled).Value = dt.Rows(i)("IsCanceled") = 1
            ...
            G.Rows(i).Cells(GC.OperationId2).Value = dt.Rows(i)("OperationId2").ToString
            G.Rows(i).Cells(GC.RoomId).Value = dt.Rows(i)("RoomId").ToString
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click, btnPrint.Click, btnApproval1.Click, btnApproval2.Click, btnApproval3.Click, btnApproval4.Click, btnApproval5.Click
        ...
        If Not bm.SaveGrid(G, "CasesDetails", New String() {"CaseId"}, New String() {txtID.Text}, New String() {"IsCanceled", "TypeId", "CompanyId", "DoctorId", "OperationId", "OperationId2", "RoomId", "VisitingTypeId"}, New String() {GC.IsCanceled, GC.TypeId, GC.CompanyId, GC.DoctorId, GC.OperationId, GC.OperationId2, GC.RoomId, GC.VisitingTypeId}, New VariantType() {VariantType.Boolean, VariantType.Integer, VariantType.Integer, VariantType.Integer, VariantType.Integer, VariantType.Integer, VariantType.Integer, VariantType.Integer}, New String() {GC.TypeId}, "Line", "Line") Then Return
