...
Public Class Chart
    ...
    Private Sub Chart_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        Dim v() As String = {SubId, "Name", "MainAccId", "MotionType", "SubType", "LinkFile", "Level", "EndType", "Bal0", "Id2", "HideFromAccountEnd", "IsZakat", "TaxType", "TaxSubType"}
        bm.Fields = v
        Dim c() As Control = {txtID, txtName, AccNo, MotionType, SubType, LinkFile, Level, EndType, Bal0, Id2, HideFromAccountEnd, IsZakat, TaxType, TaxSubType}
        bm.control = c
