...
Public Class DepartmentTypes
    Public TableName As String = "DepartmentTypes"
    Public SubId As String = "Flag"
    Public SubId2 As String = "Id"

    Public SubName As String = "Name"

    Public TableDetailsName As String = "EmpDepartmentTypes"
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.Fields = {SubId, SubId2, SubName}
        bm.control = {txtFlag, txtID, txtName}
