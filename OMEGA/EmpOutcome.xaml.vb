...
Public Class EmpOutcome
    ...
    Sub ClearControls()
        Try
            ...
            txtID.Text = bm.ExecuteScalar("select isnull(max(" & SubId & "),0)+1 from " & TableName & " where " & MainId & "='" & CboMain.SelectedValue.ToString & "' and " & MainId2 & "='" & bm.ToStrDate(DayDate.SelectedDate) & "'")
