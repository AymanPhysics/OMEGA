...
Public Class HelpCustomers
    ...
    Private Sub Help_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Loaded
        ThirdColumn = IIf(Md.MyProjectType = ProjectType.AboHamza, "الضامن", ThirdColumn)
        ...
        Try
            dt = bm.ExecuteAdapter(IIf(Md.MyProjectType = ProjectType.AboHamza, "CustomersSearch_AZ", "CustomersSearch"))
            dt.TableName = "tbl"
    ...
    Private Sub btnSave_Click(sender As Object, e As RoutedEventArgs) Handles btnSave.Click
        ...
        If Md.MyProjectType = ProjectType.AboHamza Then
            If txtTel.Text.Trim.Length = 0 Then
                bm.ShowMSG("برجاء تحديد " & FourthColumn)
                txtTel.Focus()
                Return
            End If
            'If txtMob.Text.Trim.Length = 0 Then
            '    bm.ShowMSG("برجاء تحديد " & FifthColumn)
            '    txtMob.Focus()
            '    Return
            'End If
        End If
        ...
        If Not bm.AddItemToTable("Customers", {"Name", "Tel", "Mobile", "Address", "AccNo", IIf(Md.MyProjectType = ProjectType.AboHamza, "Person", "NationalId")}, {txtArName.Text, txtTel.Text, txtMob.Text, txtAddress.Text, CboAccNo.SelectedValue.ToString, NationalId.Text}) Then Return
    ...
    Private Sub LoadResource()
        ...
        If Md.MyProjectType = ProjectType.AboHamza Then
            FourthColumn = "تليفون أساسي"
            FifthColumn = "تليفونإضافي"
        Else
