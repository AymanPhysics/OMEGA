...
Public Class ItemsDelivery
    ...
    Private Sub LoadG2()
        Try
            ...
            DataGridView2.Columns(dt2.Columns("CustomerNotes").Ordinal).IsReadOnly = False
            ...
            DataGridView2.Columns(dt2.Columns("CustomerNotes").Ordinal).Header = "ملاحظات العميل"
    ...
    Private Sub btnSave1_Click(sender As Object, e As RoutedEventArgs) Handles btnSave1.Click
        ...
        For index = 0 To DataGridView2.Items.Count - 1
            ...
            str &= " update SalesDeliveryHistory set CustomerNotes='" & DataGridView2.Items(index)("CustomerNotes") & "' where StoreId='" & Val(StoreId.Text) & "' and InvoiceNo='" & Val(SalesDeliveryHistoryInvoiceNo.Text) & "' and CustomerId='" & DataGridView2.Items(index)("ToId") & "'  "
    ...
    Private Sub btnSave4_Click(sender As Object, e As RoutedEventArgs) Handles btnSave4.Click
        If Val(StoreId.Text) = 0 Then
            bm.ShowMSG("برجاء تحديد مخزن")
            StoreId.Focus()
            Return
        ...
        If Val(SalesDeliveryHistoryInvoiceNo.Text) = 0 Then
            ...
            SalesDeliveryHistoryInvoiceNo.Focus()
            Return
        End If
