...
Partial Public Class MainPage
    ...
    Private Sub LoadGFile(CurrentTab As Integer)
        ...
        If Md.MyProjectType = ProjectType.TransportationShawkat OrElse Md.MyProjectType = ProjectType.ContractRaggal Then
        ...
        If Not Md.MyProjectType = ProjectType.ClinicWomen AndAlso Not Md.MyProjectType = ProjectType.ClinicDrSaberWaheeb AndAlso Not Md.MyProjectType = ProjectType.MedicalCenter Then
            AddHandler LoadRadio(103, G, "Countries").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                   ...
                                                                   If Md.MyProjectType = ProjectType.TransportationShawkat Then bm.SetImage(CType(frm, BasicForm).Img, "CustomerInvoicesItems.Jpg")
                                                                   sender.Tag = New MyPage With {.Content = frm}
                                                               End Sub
        ...
        If Md.MyProjectType = ProjectType.ClinicDrSaberWaheeb Then
        ...
        If Md.MyProjectType = ProjectType.ClinicPublicElSadaka OrElse Md.MyProjectType = ProjectType.APSD OrElse Md.MyProjectType = ProjectType.APS OrElse Md.MyProjectType = ProjectType.RivieraCenter OrElse Md.MyProjectType = ProjectType.X5 Then
        ...
        If Not Md.MyProjectType = ProjectType.ClinicDrSaberWaheeb Then
        ...
        If Md.MyProjectType = ProjectType.ZohorOLDXXXXX OrElse Md.MyProjectType = ProjectType.ClinicPublic OrElse Md.MyProjectType = ProjectType.ClinicWomen OrElse Md.MyProjectType = ProjectType.ClinicDrSaberWaheeb OrElse Md.MyProjectType = ProjectType.ClinicPublicElSadaka OrElse Md.MyProjectType = ProjectType.APSD OrElse Md.MyProjectType = ProjectType.APS OrElse Md.MyProjectType = ProjectType.MedicalCenter Then
            ...
            If Not Md.MyProjectType = ProjectType.ClinicWomen AndAlso Not Md.MyProjectType = ProjectType.ClinicDrSaberWaheeb Then
        ...
        If Md.MyProjectType = ProjectType.PLEvents Then
            LoadLabel(148, G, "")
            ...
            AddHandler LoadRadio(163, G, "Print ID").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                  frm = New ConferencesCheckInOut With {.Flag = 4}
                                                                  sender.Tag = New MyPage With {.Content = frm}
                                                              End Sub
            ...
            AddHandler LoadRadio(164, G, "Send IDs by Email").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                           frm = New RPTFromIdToId With {.Flag = 8}
                                                                           sender.Tag = New MyPage With {.Content = frm}
                                                                       End Sub

            AddHandler LoadRadio(165, G, "Send IDs by WhatsApp").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                              frm = New RPTFromIdToId With {.Flag = 9}
                                                                              sender.Tag = New MyPage With {.Content = frm}
                                                                          End Sub
    ...
    Private Sub LoadGClinics(CurrentTab As Integer)
        Dim G As WrapPanel = MakePanel(CurrentTab, IIf(Md.MyProjectType = ProjectType.APSD OrElse Md.MyProjectType = ProjectType.APS, "Department", "Clinics"), "reservation.jpg")
        Dim frm As UserControl
        ...
        If Md.MyProjectType = ProjectType.APS Then
            ...
            AddHandler LoadRadio(252, G, "أقسام إخلاء طرف").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                         frm = New DepartmentTypes
                                                                         sender.Tag = New MyPage With {.Content = frm}
                                                                     End Sub
        ...
        ElseIf Md.MyProjectType = ProjectType.ZohorOLDXXXXX OrElse Md.MyProjectType = ProjectType.APS OrElse Md.MyProjectType = ProjectType.ClinicPublic Then
            AddHandler LoadRadio(203, G, "Patients Data").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                       ...
                                                                       sender.Tag = New MyPage With {.Content = frm}
                                                                   End Sub
        ElseIf Md.MyProjectType = ProjectType.ClinicDrSaberWaheeb Then
        ...
        Else
            AddHandler LoadRadio(205, G, "Patients Data").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                       frm = New Cases With {.IsSub = IIf(Md.MyProjectType = ProjectType.APSD, True, False)}
                                                                       sender.Tag = New MyPage With {.Content = frm}
                                                                   End Sub
        End If
        ...
        If Md.MyProjectType = ProjectType.ClinicWomen OrElse Md.MyProjectType = ProjectType.MedicalCenter Then
        ...
        If Not Md.MyProjectType = ProjectType.ClinicWomen AndAlso Not Md.MyProjectType = ProjectType.ClinicDrSaberWaheeb Then
            If Md.MyProjectType = ProjectType.ClinicPublicElSadaka Then
        ...
        If Md.MyProjectType = ProjectType.APSD OrElse Md.MyProjectType = ProjectType.APS Then 'Md.MyProjectType = ProjectType.ZohorOLDXXXXX OrElse 
        ...
        Select Case Md.MyProjectType
            ...
            Case ProjectType.ClinicDrSaberWaheeb
        ...
        If Not Md.MyProjectType = ProjectType.APSD AndAlso Not Md.MyProjectType = ProjectType.APS AndAlso Not Md.MyProjectType = ProjectType.ClinicDrSaberWaheeb Then
        ...
        If Md.MyProjectType = ProjectType.APS Then 'Md.MyProjectType = ProjectType.ZohorOLDXXXXX OrElse
            ...
            AddHandler LoadRadio(253, G, "إخلاء طرف").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                   frm = New RPT49 With {.Flag = 1}
                                                                   sender.Tag = New MyPage With {.Content = frm}
                                                               End Sub
    ...
    Private Sub LoadGStores(CurrentTab As Integer)
        ...
        If Not Md.ShowQtySub Then
            If Not Md.MyProjectType = ProjectType.MarketWithShifts AndAlso Not Md.MyProjectType = ProjectType.Market Then
        ...
        If Md.MyProjectType = ProjectType.RivieraCenter Then
            ...
            AddHandler LoadRadio(581, G, "Boards").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                frm = New BasicForm With {.TableName = "Boards"}
                                                                sender.Tag = New MyPage With {.Content = frm}
                                                            End Sub

            AddHandler LoadRadio(582, G, "SubjectLevels").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                       frm = New BasicForm With {.TableName = "SubjectLevels"}
                                                                       sender.Tag = New MyPage With {.Content = frm}
                                                                   End Sub

            AddHandler LoadRadio(583, G, "Subjects").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                  frm = New BasicForm With {.TableName = "Subjects"}
                                                                  sender.Tag = New MyPage With {.Content = frm}
                                                              End Sub

            AddHandler LoadRadio(584, G, "Riviera Veiw").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                      frm = New RivieraVeiw
                                                                      sender.Tag = New MyPage With {.Content = frm}
                                                                  End Sub
        ...
        If Md.MyProjectType = ProjectType.ClinicPublicElSadaka Then str = "Donations"
        If Md.MyProjectType = ProjectType.X3 Then str = "InventoryAdding"
        ...
        str = "Exchange"
        If Md.MyProjectType = ProjectType.X3 Then str = "InventoryExchange"
        ...
        If Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.PremiumMedicalSupplies Then
        ...
        If Md.MyProjectType = ProjectType.Eagle Then
        ...
        ElseIf Md.MyProjectType = ProjectType.Clothes Then
        ...
        If Md.MyProjectType = ProjectType.RivieraCenter OrElse Md.MyProjectType = ProjectType.Eagle Then
        ...
        If Md.MyProjectType = ProjectType.Perfume Then
        ...
        If Md.MyProjectType = ProjectType.RivieraCenter Then
            ...
            AddHandler LoadRadio(567, G, "Special Orders").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                        frm = New SpecialOrders
                                                                        sender.Tag = New MyPage With {.Content = frm}
                                                                    End Sub

            AddHandler LoadRadio(586, G, "استلام المرتجعات").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                          frm = New SpecialOrders2
                                                                          sender.Tag = New MyPage With {.Content = frm}
                                                                      End Sub

            AddHandler LoadRadio(585, G, "طلبات الفروع").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                      frm = New Inventory2
                                                                      sender.Tag = New MyPage With {.Content = frm}
                                                                  End Sub
        End If
        ...
        If Md.MyProjectType = ProjectType.Eagle Then
            AddHandler LoadRadio(568, G, "Tenders").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                 frm = New Tenders
                                                                 sender.Tag = New MyPage With {.Content = frm}
                                                             End Sub
        End If
    ...
    Private Sub LoadGSalaries(CurrentTab As Integer)
        Dim s As String = ""
        Select Case Md.MyProjectType
            Case ProjectType.ClinicPublicElSadaka, ProjectType.APSD, ProjectType.APS
                s = "reservation.jpg"
            Case Else
                s = "MainOMEGA.jpg"
        End Select
    ...
    Private Sub LoadGAccountants(CurrentTab As Integer)
        ...
        If Md.MyProjectType <> ProjectType.ClinicPublicElSadaka AndAlso Md.MyProjectType <> ProjectType.APSD AndAlso Md.MyProjectType <> ProjectType.APS Then
        ...
        If Md.MyProjectType = ProjectType.TransportationShawkat OrElse Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X4 OrElse Md.MyProjectType = ProjectType.APS OrElse Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.PremiumMedicalSupplies OrElse Md.MyProjectType = ProjectType.RivieraCenter Then
        ...
        If Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X4 OrElse Md.MyProjectType = ProjectType.X2 Then
        ...
        If Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X4 OrElse Md.MyProjectType = ProjectType.X1 Then
        ...
        If Md.MyProjectType = ProjectType.AboHamza OrElse Md.MyProjectType = ProjectType.Installments OrElse Md.MyProjectType = ProjectType.X1 Then
        ...
        If Md.MyProjectType = ProjectType.RivieraCenter Then
            ...
            AddHandler LoadRadio(871, G, "القاعات").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                 frm = New BasicForm2 With {.MainTableName = "Stores", .MainSubId = "Id", .MainSubName = "Name", .lblMain_Content = "السنتر", .TableName = "CenterRooms", .MainId = "StoreId", .SubId = "Id", .SubName = "Name"}

                                                                 sender.Tag = New MyPage With {.Content = frm}
                                                             End Sub

            AddHandler LoadRadio(872, G, "إيراد السنتر").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                      frm = New BankCash6
                                                                      sender.Tag = New MyPage With {.Content = frm}
                                                                  End Sub

            AddHandler LoadRadio(873, G, "جدول السنتر").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                     frm = New BankCash62
                                                                     sender.Tag = New MyPage With {.Content = frm}
                                                                 End Sub
        ...
        If Md.MyProjectType = ProjectType.AboHamza OrElse Md.MyProjectType = ProjectType.Installments OrElse Md.MyProjectType = ProjectType.X1 Then
            LoadLabel(870, G, "Investors")

            AddHandler LoadRadio(863, G, "InvestorsProfits").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                          frm = New InvestorsProfits
                                                                          sender.Tag = New MyPage With {.Content = frm}
                                                                      End Sub


            AddHandler LoadRadio(864, G, "IncomeFromInvestors").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                             frm = New BankCash5 With {.Flag = 1, .MyLinkFile = 5}
                                                                             sender.Tag = New MyPage With {.Content = frm}
                                                                         End Sub

            AddHandler LoadRadio(865, G, "OutComeToInvestors").Checked, Sub(sender As Object, e As RoutedEventArgs)
        ...
        If Md.MyProjectType = ProjectType.Installments Then
            AddHandler LoadRadio(866, G, "InstallmentAlterts").Checked, Sub(sender As Object, e As RoutedEventArgs)
        ...
        If Md.MyProjectType = ProjectType.X3 Then
            AddHandler LoadRadio(867, G, "عمولات البائعين").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                         frm = New SellersProfits
                                                                         sender.Tag = New MyPage With {.Content = frm}
                                                                     End Sub

            AddHandler LoadRadio(868, G, "توزيعات مدفوعات الموردين").Checked, Sub(sender As Object, e As RoutedEventArgs)
    ...
    Private Sub LoadGOperations(CurrentTab As Integer)
        Dim G As WrapPanel = MakePanel(CurrentTab, "Operations", "MainOMEGA.jpg")
        Dim frm As UserControl
    ...
    Sub LoadGInstallments(CurrentTab As Integer)
        ...
        AddHandler LoadRadio(10107, G, "القبول الأمني").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                     frm = New CustomerAcceptance With {.Flag = 1}
                                                                     sender.Tag = New MyPage With {.Content = frm}
                                                                 End Sub

        AddHandler LoadRadio(10108, G, "توزيع المستعلمين").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                        frm = New CustomerAcceptance With {.Flag = 4}
                                                                        sender.Tag = New MyPage With {.Content = frm}
                                                                    End Sub

        AddHandler LoadRadio(10109, G, "القبول الميداني").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                       frm = New CustomerAcceptance With {.Flag = 2}
                                                                       sender.Tag = New MyPage With {.Content = frm}
                                                                   End Sub

        AddHandler LoadRadio(10110, G, "تسليم وإلغاء الطلبات").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                            frm = New CustomerAcceptance With {.Flag = 3}
                                                                            sender.Tag = New MyPage With {.Content = frm}
                                                                        End Sub
    ...
    Sub LoadGTaxETA(CurrentTab As Integer)
        Dim G As WrapPanel = MakePanel(CurrentTab, "مصلحة الضرائب ETA", "MainOMEGA.jpg")
        Dim frm As UserControl

        LoadLabel(10201, G, "المخازن")


        AddHandler LoadRadio(10202, G, "Groups").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                              frm = New Groups
                                                              sender.Tag = New MyPage With {.Content = frm}
                                                          End Sub


        AddHandler LoadRadio(10203, G, "Types").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                             'frm = New BasicForm2 With {.MainTableName = "Groups", .MainSubId = "Id", .MainSubName = "Name", .lblMain_Content = "Group", .TableName = "Types", .MainId = "GroupId", .SubId = "Id", .SubName = "Name"}
                                                             frm = New Types
                                                             sender.Tag = New MyPage With {.Content = frm}
                                                         End Sub
        ...
        If Not Md.ShowQtySub Then
            AddHandler LoadRadio(10204, G, "Itemunits").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                     frm = New BasicForm With {.TableName = "Itemunits"}
                                                                     sender.Tag = New MyPage With {.Content = frm}
                                                                 End Sub
        End If
        ...
        If Md.ShowBarcode Then
            AddHandler LoadRadio(10206, G, "Print Barcode").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                         frm = New RPT18 With {.Flag = 1}
                                                                         sender.Tag = New MyPage With {.Content = frm}
                                                                     End Sub

            AddHandler LoadRadio(10207, G, "Print Barcode Grid").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                              frm = New PrintParcodeGrid
                                                                              sender.Tag = New MyPage With {.Content = frm}
                                                                          End Sub
        ...
        AddHandler LoadRadio(10208, G, "Sales").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                             frm = New Sales With {.Flag = Sales.FlagState.المبيعات}
                                                             If Md.MyProjectType = ProjectType.X5 Then
                                                                 frm = New Sales2 With {.Flag = Sales2.FlagState.المبيعات}
                                                             End If
        ...
        AddHandler LoadRadio(10209, G, "Sales Returns").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                     frm = New Sales With {.Flag = Sales.FlagState.مردودات_المبيعات}
                                                                     sender.Tag = New MyPage With {.Content = frm}
                                                                 End Sub

        LoadLabel(10210, G, "الحسابات")


        AddHandler LoadRadio(10211, G, "Chart").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                             frm = New Chart
                                                             sender.Tag = New MyPage With {.Content = frm}
                                                         End Sub
        AddHandler LoadRadio(10212, G, "Customers").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                 frm = New Customers
                                                                 sender.Tag = New MyPage With {.Content = frm}
                                                             End Sub


        LoadLabel(10213, G, "ETA")

        AddHandler LoadRadio(10214, G, "TokenPin").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                frm = New BasicForm With {.TableName = "TokenPins"}
                                                                sender.Tag = New MyPage With {.Content = frm}
                                                            End Sub


        AddHandler LoadRadio(10215, G, "ETA البيئة التجريبية").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                            frm = New SalesUploadToETA With {.IsPreProd = True}
                                                                            sender.Tag = New MyPage With {.Content = frm}
                                                                        End Sub

        AddHandler LoadRadio(10216, G, "ETA البيئة الفعلية").Checked, Sub(sender As Object, e As RoutedEventArgs)
    ...
    Private Sub LoadGClinicsReports(CurrentTab As Integer)
        ...
        If Md.MyProjectType = ProjectType.APS Then
            ...
            AddHandler LoadRadio(1250, G, "إخلاء طرف").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                    frm = New RPT33 With {.Flag = 6}
                                                                    sender.Tag = New MyPage With {.Content = frm}
                                                                End Sub
    ...
    Private Sub LoadGStoresReports(CurrentTab As Integer)
        ...
        If Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.PremiumMedicalSupplies Then
        ...
        If Md.MyProjectType = ProjectType.RivieraCenter Then
            ...
            AddHandler LoadRadio(1604, G, "Special Orders").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                         frm = New RPTFromDateToDate With {.Flag = 9}
                                                                         sender.Tag = New MyPage With {.Content = frm}
                                                                     End Sub

            AddHandler LoadRadio(1606, G, "استلام المرتجعات").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                           frm = New RPTFromDateToDate With {.Flag = 11}
                                                                           sender.Tag = New MyPage With {.Content = frm}
                                                                       End Sub

            AddHandler LoadRadio(1605, G, "طلبات الفروع").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                       frm = New RPTFromDateToDate With {.Flag = 10}
                                                                       sender.Tag = New MyPage With {.Content = frm}
                                                                   End Sub

            AddHandler LoadRadio(1605, G, "تفاصيل المرتجعات").Checked, Sub(sender As Object, e As RoutedEventArgs)
        ...
        If Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X4 OrElse Md.MyProjectType = ProjectType.RivieraCenter OrElse Md.MyProjectType = ProjectType.Eagle Then
        ...
        If Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X4 OrElse Md.MyProjectType = ProjectType.X1 Then
            ...
            If Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X1 Then
        ...
        Else
            ...
            AddHandler LoadRadio(1540, G, "ربحية مبيعات تفصيلي").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                              frm = New RPT6 With {.Flag = 30, .Detail = 4}
                                                                              sender.Tag = New MyPage With {.Content = frm}
                                                                          End Sub

            If Md.MyProjectType = ProjectType.Installments Then
                AddHandler LoadRadio(1598, G, "ربحية مبيعات إجمالي").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                                  frm = New RPT6 With {.Flag = 30, .Detail = 23}
                                                                                  sender.Tag = New MyPage With {.Content = frm}
                                                                              End Sub
            End If
            ...
            AddHandler LoadRadio(1602, G, "عملاء راكدون").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                       frm = New RPT6 With {.Flag = 3, .Detail = 120}
                                                                       sender.Tag = New MyPage With {.Content = frm}
                                                                   End Sub

            AddHandler LoadRadio(1603, G, "عملاء متأخرون").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                        frm = New RPT6 With {.Flag = 3, .Detail = 121}
                                                                        sender.Tag = New MyPage With {.Content = frm}
                                                                    End Sub
            ...
            AddHandler LoadRadio(1601, G, "أصناف راكدة").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                      frm = New RPT6 With {.Flag = 3, .Detail = 25}
                                                                      sender.Tag = New MyPage With {.Content = frm}
                                                                  End Sub
            ...
            If Md.MyProjectType = ProjectType.RivieraCenter Then
                AddHandler LoadRadio(1599, G, "مبيعات وأرصدة الفروع").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                                   frm = New RPT6 With {.Flag = 3, .Detail = 24}
                                                                                   sender.Tag = New MyPage With {.Content = frm}
                                                                               End Sub
            End If

            If Md.MyProjectType = ProjectType.X4 Then
        ...
        AddHandler LoadRadio(1600, G, "تعديلات المبيعات").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                       frm = New SalesMotion
                                                                       sender.Tag = New MyPage With {.Content = frm}
                                                                   End Sub


        If Md.MyProjectType = ProjectType.Clothes OrElse Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X4 OrElse Md.MyProjectType = ProjectType.APS Then
    ...
    Private Sub LoadGAccountsReports(CurrentTab As Integer)
        ...
        If Md.MyProjectType = ProjectType.AboHamza Then
            AddHandler LoadRadio(1895, G, "يوم ميلاد العملاء").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                            frm = New RPT38 With {.Flag = 4}
                                                                            sender.Tag = New MyPage With {.Content = frm}
                                                                        End Sub
        End If
        ...
        If Md.MyProjectType = ProjectType.RivieraCenter Then
            ...
            AddHandler LoadRadio(1900, G, "يومية الفروع").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                       frm = New RPT38 With {.Flag = 5}
                                                                       sender.Tag = New MyPage With {.Content = frm}
                                                                   End Sub


            AddHandler LoadRadio(1894, G, "نقاط العملاء").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                       frm = New RPT38 With {.Flag = 3}
                                                                       sender.Tag = New MyPage With {.Content = frm}
                                                                   End Sub

            AddHandler LoadRadio(1899, G, "إيراد السنتر").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                       frm = New RPT48 With {.Flag = 1}
                                                                       sender.Tag = New MyPage With {.Content = frm}
                                                                   End Sub
        ...
        If Not Md.MyProjectType = ProjectType.Perfume Then
        ...
        If Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X4 OrElse Md.MyProjectType = ProjectType.AlSafwaTrading OrElse Md.MyProjectType = ProjectType.AsebAcc OrElse Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X1 Then
        ...
        Else
            ...
            If Md.MyProjectType = ProjectType.TransportationShawkat OrElse Md.MyProjectType = ProjectType.Clothes OrElse Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.ContractRaggal OrElse Md.MyProjectType = ProjectType.X4 OrElse Md.MyProjectType = ProjectType.APS OrElse Md.MyProjectType = ProjectType.AlSafwaTrading OrElse Md.MyProjectType = ProjectType.X2 Then
            ...
            If Md.MyProjectType = ProjectType.X3 OrElse Md.MyProjectType = ProjectType.X2 Then
            ...
            If Md.MyProjectType = ProjectType.RivieraCenter Then
                ...
                AddHandler LoadRadio(1897, G, "إيرادات مدرس - سنتر - تفصيلي").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                                           frm = New RPT2 With {.Flag = 4, .MyLinkFile = 14}
                                                                                           sender.Tag = New MyPage With {.Content = frm}
                                                                                       End Sub

                AddHandler LoadRadio(1898, G, "إيرادات مدرس - سنتر - إجمالي").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                                           frm = New RPT2 With {.Flag = 5, .MyLinkFile = 14}
                                                                                           sender.Tag = New MyPage With {.Content = frm}
                                                                                       End Sub

                AddHandler LoadRadio(1896, G, "Teacher Graph").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                            frm = New RPT47 With {.Flag = 1}
                                                                            sender.Tag = New MyPage With {.Content = frm}
                                                                        End Sub
            End If

            If Md.MyProjectType = ProjectType.Installments OrElse Md.MyProjectType = ProjectType.X1 Then
            ...
            If Md.MyProjectType = ProjectType.Perfume Then Return
    ...
    Private Sub LoadGOperationsReports(CurrentTab As Integer)
        Dim G As WrapPanel = MakePanel(CurrentTab, "Operations Reports", "MainOMEGA.jpg")
        Dim frm As UserControl
    ...
    Private Sub LoadGInstallmentsReports(CurrentTab As Integer)
        ...
        AddHandler LoadRadio(20113, G, "نتيجة المبيعات الشهرية").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                              frm = New RPTSalesCalender
                                                                              sender.Tag = New MyPage With {.Content = frm}
                                                                          End Sub
        ...
        LoadLabel(20106, G, "القبول والرفض")

        AddHandler LoadRadio(20107, G, "قبول أمني").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                 frm = New RPT46 With {.Flag = 1, .RptFlag = 1}
                                                                 sender.Tag = New MyPage With {.Content = frm}
                                                             End Sub

        AddHandler LoadRadio(20108, G, "رفض أمني").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                frm = New RPT46 With {.Flag = 1, .RptFlag = 2}
                                                                sender.Tag = New MyPage With {.Content = frm}
                                                            End Sub

        AddHandler LoadRadio(20109, G, "قبول ميداني").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                   frm = New RPT46 With {.Flag = 1, .RptFlag = 3}
                                                                   sender.Tag = New MyPage With {.Content = frm}
                                                               End Sub

        AddHandler LoadRadio(20110, G, "رفض ميداني").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                  frm = New RPT46 With {.Flag = 1, .RptFlag = 4}
                                                                  sender.Tag = New MyPage With {.Content = frm}
                                                              End Sub

        AddHandler LoadRadio(20111, G, "تسليم الطلب").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                   frm = New RPT46 With {.Flag = 1, .RptFlag = 5}
                                                                   sender.Tag = New MyPage With {.Content = frm}
                                                               End Sub

        AddHandler LoadRadio(20112, G, "إلغاء الطلب").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                   frm = New RPT46 With {.Flag = 1, .RptFlag = 6}
                                                                   sender.Tag = New MyPage With {.Content = frm}
                                                               End Sub

        AddHandler LoadRadio(20112, G, "إحصائية القبول والرفض").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                             frm = New RPT46 With {.Flag = 2}
                                                                             sender.Tag = New MyPage With {.Content = frm}
                                                                         End Sub
        '20113
    End Sub

    Private Sub LoadGTaxETAReports(CurrentTab As Integer)
        Dim s As String = "MainOMEGA.Jpg"

        Dim G As WrapPanel = MakePanel(CurrentTab, "ETA Reports", s)
        Dim frm As UserControl

        AddHandler LoadRadio(202001, G, "Sales Invoices Detailed").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                                frm = New RPT6 With {.Flag = 3, .Detail = 1}
                                                                                sender.Tag = New MyPage With {.Content = frm}
                                                                            End Sub

        AddHandler LoadRadio(202002, G, "Sales Invoices Total").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                             frm = New RPT6 With {.Flag = 3, .Detail = 0}
                                                                             sender.Tag = New MyPage With {.Content = frm}
                                                                         End Sub

        AddHandler LoadRadio(202006, G, "Items Sales Summarized").Checked, Sub(sender As Object, e As RoutedEventArgs)
                                                                               frm = New RPT6 With {.Flag = 3, .Detail = 15}
                                                                               sender.Tag = New MyPage With {.Content = frm}
                                                                           End Sub
    ...
    Private Async Sub LoadTabs()
        ...
        If Md.MyProjectType = ProjectType.TransportationShawkat Then
            LoadDailyMotion(10)
        End If
