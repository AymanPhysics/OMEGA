...
Module Md
    ...
    Public PrintPoneA5 As Boolean = False
    Public Demo As Boolean = False
    Public gmail, gmailPassword As String
    Public whatsmateINSTANCE_ID, whatsmateCLIENT_ID, whatsmateCLIENT_SECRET As String
    Public smsmisrSenderID, smsmisrUsername, smsmisrPassword As String
    Public CheckItemBal As Boolean = False
    Public ShowPurchasePrice As Boolean = False
    Public PreventItemDoublication As Boolean = False
    Public ShowNotifications As Boolean = False
    Public ShowWeightQty As Boolean = False
    ...
    Enum ProjectType
        ...
        APS ' Noha
        AsebAcc
        MarketWithShifts 'ADehimy & Toson 
        ...
        RivieraCenter
        X2
        PremiumMedicalSupplies 'AhmedMahdy
        X5
        Installments 'A-ONE
        X1
        AboHamza
