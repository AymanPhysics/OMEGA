...
Public Class ProductionPlan
    ...
    Structure GC
        ...
        Shared Priority As String = "Priority"
    End Structure
    ...
    Private Sub LoadWFH(WFH As Forms.Integration.WindowsFormsHost, G As MyGrid)
        ...
        G.Columns.Add(GC.Priority, "الأولوية")
...
Br:
    ...
    Sub FillControls()
        ...
        For i As Integer = 0 To dt.Rows.Count - 1
            ...
            G.Rows(i).Cells(GC.Priority).Value = dt.Rows(i)("Priority").ToString.Trim
            CalcRow(i)
        Next
        G.RefreshEdit()
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Not bm.SaveGrid(G, TableDetailsName, New String() {"InvoiceNo"}, New String() {InvoiceNo.Text}, New String() {"Barcode", "ItemId", "ItemName", "Qty", "Priority"}, New String() {GC.Barcode, GC.ItemId, GC.ItemName, GC.Qty, GC.Priority}, New VariantType() {VariantType.String, VariantType.String, VariantType.String, VariantType.Integer, VariantType.Decimal, VariantType.Integer}, New String() {GC.ItemId}) Then Return
    ...
    Private Sub GridKeyDown(ByVal sender As Object, ByVal e As Forms.KeyEventArgs)
        ...
        Try
            ...
            If bm.ShowHelpGridItemBal(G.CurrentRow.Cells(GC.ItemId), G.CurrentRow.Cells(GC.ItemName), e, IIf(Md.MyProjectType = ProjectType.Clothes, "GetItemCurrentBal ", "GetItemCurrentBal2 ") & Val(G.CurrentRow.Cells(GC.ItemId).Value)) Then
                GridCalcRow(sender, New Forms.DataGridViewCellEventArgs(G.Columns(GC.ItemId).Index, G.CurrentCell.RowIndex))
                If G.Rows(G.CurrentCell.RowIndex).Cells(GC.Qty).Visible Then
                    G.CurrentCell = G.Rows(G.CurrentCell.RowIndex).Cells(GC.Qty)
                End If
