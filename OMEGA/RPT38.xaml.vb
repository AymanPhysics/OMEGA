...
Public Class RPT38
    ...
    Public Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Button2.Click
        ...
        rpt.paraname = New String() {"@CountryId", "@CityId", "@AreaId", "@Ban", "Header"}
        rpt.paravalue = New String() {Val(CountryId.Text), Val(CityId.Text), Val(AreaId.Text), Val(Ban.SelectedIndex), CType(Parent, Page).Title}
        ...
        Select Case Flag
            ...
            Case 3
                rpt.Rpt = "CustomersPoints.rpt"
            Case 4
                rpt.Rpt = "CustomersDateOfBirth.rpt"
            Case 5
                rpt.Rpt = "RivieraSummarization.rpt"
        End Select
        rpt.Show()
    End Sub
    ...
    Private Sub UserControl_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        If Flag = 2 OrElse Flag = 5 Then
            ...
            Ban.Visibility = Visibility.Hidden
            lblBan.Visibility = Visibility.Hidden
        End If
    End Sub
