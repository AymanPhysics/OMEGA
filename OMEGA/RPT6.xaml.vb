...
Public Class RPT6
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Button2.Click
        ...
        Select Case Detail
            ...
            Case 1
                ...
                End If
            Case 2
                rpt.Rpt = IIf(Md.MyProjectType = ProjectType.X3, "DeletedSales_N.rpt", "DeletedSales.rpt")
            Case 3
                rpt.Rpt = "ItemsSales5.rpt"
            Case 4
                rpt.Rpt = IIf(Md.MyProjectType = ProjectType.X3, "SalesProfit_N.rpt", "SalesProfit.rpt")
                rpt.Rpt = IIf(Md.MyProjectType = ProjectType.RivieraCenter, "SalesProfit_R.rpt", "SalesProfit.rpt")
            Case 5
            ...
            Case 7
                ...
                ElseIf Md.MyProjectType = ProjectType.X3 Then
            ...
            Case 120
                rpt.Rpt = "ItemsSales80.rpt"
            Case 121
                rpt.Rpt = "ItemsSales82.rpt"
            Case 13
            ...
            Case 23
                rpt.Rpt = "SalesProfit2.rpt"
            Case 24
                rpt.Rpt = "ItemsSales42.rpt"
            Case 25
                rpt.Rpt = "Items25.rpt"
        End Select
        rpt.Show()
    ...
    Private Sub UserControl_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        If (Flag = 3 OrElse Flag = 30 OrElse Flag = 9 OrElse Flag = 31 OrElse Flag = 28) AndAlso (Detail = 0 OrElse Detail = 1) Then
            ...
            If Md.MyProjectType = ProjectType.RivieraCenter AndAlso (Flag = 3 OrElse Flag = 30) Then
