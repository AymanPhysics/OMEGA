...
Public Class RPTFromDateToDate
    ...
    Public Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Button2.Click
        ...
        rpt.paraname = New String() {"@StoreId", "StoreName", "@FromDate", "@ToDate", "Header", "@Flag", "@FromInvoiceNo", "@ToInvoiceNo"}
        rpt.paravalue = New String() {Val(StoreId.Text), StoreName.Text, FromDate.SelectedDate, ToDate.SelectedDate, CType(Parent, Page).Title, MyFlag, 0, 0}
        Select Case Flag
            Case 1
            ...
            Case 9
                rpt.Rpt = "SpecialOrders.rpt"
            Case 10
                rpt.Rpt = "Inventory2Pone.rpt"
            Case 11
                rpt.Rpt = "SpecialOrders2.rpt"
            Case 12
                rpt.Rpt = "SalesReturn.rpt"
        End Select
        rpt.Show()
    End Sub
