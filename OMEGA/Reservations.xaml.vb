...
Public Class Reservations
    ...
    Private Sub UserControl_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        If Md.MyProjectType = ProjectType.APS Then btnAddCase.Visibility = Visibility.Hidden
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles btnSave.Click, btnSaveWithoutPrint.Click
        ...
        If Val(Payed.Text) > Val(Value.Text) Then
            bm.ShowMSG("يوجد خطأ بالإدخال")
            Value.Focus()
            Return
        End If

        If Val(Payed.Text) + Val(Remaining.Text) <> Val(Value.Text) Then
            bm.ShowMSG("يوجد خطأ بالإدخال")
            Value.Focus()
            Return
        End If
    ...
    Private Sub btnExit_Click(sender As Object, e As RoutedEventArgs) Handles btnExit.Click
        ...
        Dim dt As DataTable = bm.ExecuteAdapter("select RoomId,Id from RoomsData where CaseId=" & Val(CaseId.Text) & " and IsCurrent=1 ")
        If dt.Rows.Count > 0 Then
