...
Public Class Sales2
    ...
    Private Sub Sales_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        LoadResource()
        If Not Md.MyProjectType = ProjectType.X5 Then
        ...
        If Not Md.Manager Then
            ...
            If Md.MyProjectType = ProjectType.X5 OrElse Not Md.Manager Then
...
Br:
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If InvoiceNo.Text.Trim = "" Then
            InvoiceNo.Text = bm.ExecuteScalar("select isnull(max(" & SubId & "),0)+1 from " & TableName & " where " & MainId & "='" & StoreId.Text & "'" & bm.AppendWhere)
