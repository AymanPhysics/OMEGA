...
Public Class SalesRed
    ...
    Function ReadOnlyState() As Boolean
        If Md.Manager Then
            Return False
        ElseIf Md.MyProjectType = ProjectType.ContractRaggal OrElse Md.MyProjectType = ProjectType.Perfume OrElse Md.MyProjectType = ProjectType.MarketWithShifts OrElse Md.MyProjectType = ProjectType.Market Then
            Return False
        Else
            Return False
        End If
...
Br:
    ...
    Private Sub PrintPone(ByVal sender As System.Object, ByVal NewItemsOnly As Integer)
        ...
        If NewItemsOnly = 0 Then
            ...
            rpt.Rpt = IIf(Md.MyProjectType = ProjectType.X3, "SalesPone_N.rpt", "SalesPone.rpt")
            'If sender Is btnPrint2 Then rpt.Rpt = "SalesPone2.rpt"
            If sender Is btnPrint3 Then rpt.Rpt = IIf(Md.MyProjectType = ProjectType.X3, "SalesPone3_N.rpt", "SalesPone3.rpt")
            If sender Is btnPrint4 Then rpt.Rpt = IIf(Md.MyProjectType = ProjectType.X3, "SalesPone4_N.rpt", "SalesPone4.rpt")

            If sender Is btnPrint2 Then
                Dim i As Integer = 1
                rpt.Rpt = IIf(Md.MyProjectType = ProjectType.X3, "SalesPone2_N.rpt", "SalesPone2.rpt")
                If Md.MyProjectType = ProjectType.Clothes Then
