...
Public Class SalesUploadToETA
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        If IsPreProd Then
            uuidUrl = "https://preprod.invoicing.eta.gov.eg/documents/"
            printUrl = "https://preprod.invoicing.eta.gov.eg/print/documents/"
        End If
    ...
    Private Sub LoadWFH()
        ...
        G.Columns.Add(GC.DiscountValue, "الخصم")
    ...
    Private Sub G_CellContentClick(sender As Object, e As Forms.DataGridViewCellEventArgs)
        ...
        Dim tx As New TaxApi(TokenPin.SelectedValue, IsPreProd)
        tx.Login()
    ...
    Private Sub btnClose_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CType(Application.Current.MainWindow, MyMainWindow).TabControl1.Items.Remove(Me.Parent)
    End Sub
    ...
    Private Sub btnGet_Click(sender As Object, e As RoutedEventArgs) Handles btnGet.Click
        ...
        Dim proc As String = "getSalesMaster"
        If IsPreProd Then
            proc = "getSalesMasterPreProd"
        End If
        Dim dt As DataTable = bm.ExecuteAdapter(proc, {"FromDate", "ToDate"}, {bm.ToStrDate(FromDate.SelectedDate), bm.ToStrDate(ToDate.SelectedDate)})
