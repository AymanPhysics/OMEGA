...
Public Class Services_G
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click, btnSaveWithoutPrint.Click, btnEdit.Click
        ...
        If txtID.Text.Trim = "" Then
            txtID.Text = bm.ExecuteScalar("select isnull(max(" & SubId & "),0)+1 from " & TableName & " where Flag=" & Flag)
        ...
        If Not IsServicesLab AndAlso EmpIdReservation.SelectedIndex < 1 Then
            ...
            EmpIdReservationDateTime.Text = bm.MyGetDateTime
        End If
    ...
    Private Sub CaseId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles CaseId.KeyUp
        If bm.ShowHelpCases(CaseId, CaseName, e, IIf(Md.MyProjectType = ProjectType.APS, True, False)) Then
    ...
    Private Sub CaseID_LostFocus(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles CaseId.LostFocus
        bm.LostFocus(CaseId, CaseName, "select " & Resources.Item("CboName") & " Name from Cases where Id=" & CaseId.Text.Trim() & IIf(Md.MyProjectType = ProjectType.APS, " and InOut=1", ""))
        CaseId.ToolTip = ""
        CaseName.ToolTip = ""
        CompanyId.SelectedIndex = 0
        Dim dt As DataTable = bm.ExecuteAdapter("select HomePhone,Mobile,CompanyId from Cases where Id=" & CaseId.Text.Trim() & IIf(Md.MyProjectType = ProjectType.APS, " and InOut=1", ""))
        If dt.Rows.Count > 0 Then
    ...
    Private Sub Done_Checked(sender As Object, e As RoutedEventArgs) Handles Done.Checked
        ...
        EmpIdRemainingDateTime.Visibility = Visibility.Visible
        EmpIdRemaining.SelectedValue = Md.UserName
        EmpIdRemainingDateTime.Text = bm.MyGetDateTime
    ...
    Private Sub Done_Unchecked(sender As Object, e As RoutedEventArgs) Handles Done.Unchecked
        ...
        EmpIdRemainingDateTime.Visibility = Visibility.Hidden
    End Sub
