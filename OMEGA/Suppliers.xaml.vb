...
Public Class Suppliers
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        LoadResource()
        bm.Fields = New String() {SubId, SubName, "EnName", "AccNo", "CountryId", "CityId", "AreaId", "Address", "HeadMaster", "Tel1", "Tel2", "Tel3", "Fax", "CommercialRegister", "TaxCard", "CurrencyId", "Exchange", "MainBal0", "Bal0", "ApplyCurrencyCycle", "Type", "Notes"}
        bm.control = New Control() {txtID, txtName, txtEnName, AccNo, CountryId, CityId, AreaId, Address, HeadMaster, Tel1, Tel2, Tel3, Fax, CommercialRegister, TaxCard, CurrencyId, Exchange, MainBal0, Bal0, ApplyCurrencyCycle, Type, Notes}
